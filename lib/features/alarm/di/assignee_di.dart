import 'package:thingsboard_app/features/alarm/data/datasource/assignee/assignee_datasource.dart';
import 'package:thingsboard_app/features/alarm/data/datasource/assignee/i_assignee_datasource.dart';
import 'package:thingsboard_app/features/alarm/data/repository/assignee/assignee_repository.dart';
import 'package:thingsboard_app/features/alarm/domain/entities/assignee_entity.dart';
import 'package:thingsboard_app/features/alarm/domain/pagination/assignee/assignee_pagination_repository.dart';
...
import 'package:thingsboard_app/features/alarm/domain/usecases/assignee/fetch_assignee_usecase.dart';
...
class AssigneeDi {
  ...
  static void inti({required String scopeName}) {
    getIt.pushNewScope(
      scopeName: scopeName,
      init: (locator) {
