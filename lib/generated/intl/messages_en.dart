...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m5(message) => "Fatal application error occurred: ${message}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "createPasswordStar": MessageLookupByLibrary.simpleMessage(
      "Create a password *",
    ),
    ...
    "currentPasswordStar": MessageLookupByLibrary.simpleMessage(
      "Current password *",
    ),
    ...
    "fatalErrorMessage": m5,
    "fatalErrorTitle": MessageLookupByLibrary.simpleMessage("Fatal error"),
    ...
    "newPassword2Star": MessageLookupByLibrary.simpleMessage(
      "New password again *",
    ),
    "newPasswordRequireText": MessageLookupByLibrary.simpleMessage(
      "New password is required.",
    ),
    "newPasswordStar": MessageLookupByLibrary.simpleMessage("New password *"),
    ...
    "repeatPasswordStar": MessageLookupByLibrary.simpleMessage(
