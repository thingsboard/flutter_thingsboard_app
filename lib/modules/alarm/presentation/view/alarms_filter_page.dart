...
class _AlarmsFilterPageState extends State<AlarmsFilterPage> {
                  ...
                  Expanded(
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        ...
                        children: [
                          FilterToggleBlockWidget<FilterDataEntity<AlarmSearchStatus>>(
                            key: ValueKey(
                            ...
                            labelAtIndex:
                                (index) => filtersService.statuses.elementAt(index)
                                    .getLocalizedLabel(context),
                          ),
                          Padding(
                            padding: const EdgeInsets.symmetric(vertical: 12),
                            child: FilterToggleBlockWidget<FilterDataEntity<AlarmSeverity>>(
                              key: ValueKey(
                                filtersService.severities
                              ),
                              ...
                              labelAtIndex:
                                  (index) => filtersService.severities.elementAt(index)
                                      .getLocalizedLabel(context),
                            ),
                          ),
                          AlarmTypesWidget(
  ...
  void _resetFilters() {
    ...
    getIt<AlarmTypesBloc>().add(const AlarmTypesResetEvent());
    getIt<AssigneeBloc>().add(const AssigneeResetEvent());
    getIt<AlarmBloc>().add(const AlarmFiltersResetEvent());
  }
