...
class DevicePopDialog extends StatefulWidget {
  const DevicePopDialog({
  ...
  @override
  State<DevicePopDialog> createState() => _DevicePopDialogState();
}

class _DevicePopDialogState extends State<DevicePopDialog> {
